...
const Navbar = () => {
  ...
  return (
    <div className="w-full bg-white shadow-md px-4 md:px-10 lg:px-32 py-2 flex justify-between items-center relative">
      {/* Left section */}
      <div className="flex items-center gap-3 w-full md:w-auto">
        ...
        <div className="hidden sm:flex items-center bg-gray-100 rounded-full px-3 py-1 w-40 md:w-64">
